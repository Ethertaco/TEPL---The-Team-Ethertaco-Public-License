...
This document records the key changes and evolution of the Team Ethertaco Public License (TEPL).
...
*   **Preamble & Disclaimer:**
    *   No significant changes to the core Preamble.
    *   Retained the explicit "Disclaimer" stating non-OSI approval and user responsibility for legal compliance.
*   **Definitions (Section 1):**
    *   **1.4 "Commercial Use":**
        *   The "Integral Test" definition remains the core method for determining commercial use.
...
*   **Termination (Section 4):**
    *   **4.2 Reinstatement:** Significantly changed. Reinstatement is **no longer automatic for a first-time offense**. It now requires a written request to the copyright holders and is granted at their sole discretion after verification.
*   **Copyright Notice:**
...
*   **Definitions (Section 1):**
    *   **1.4 "Commercial Use":**
        ...
        *   Refined "Explicitly Excluded from Commercial Use" with clearer scenarios like the 90-day evaluation for for-profits.
...
*   **Permissions and Conditions (Section 2):**
    ...
    *   **2.4 License Compatibility:** Retained the AGPLv3 compatibility but without the detailed note later added in 1.2.
*   **Legal Provisions (Section 3):**
    *   Established Hong Kong SAR as the governing jurisdiction and detailed the dispute resolution process.
    *   Introduced "Resolution of Ambiguity" (favoring non-commercial status).
...
*   **Definitions (Section 1):**
    ...
    *   **1.6 "Verified Authorization":** Required from "original copyright holders."
*   **Permissions and Conditions (Section 2):**
    ...
    *   **2.2 Commercial Use Restrictions:** Required authorization through a specific email and detailed submission requirements.
...
*   **Termination (Section 4):**
    ...
    *   **4.2 Reinstatement:** Similar to 1.1, allowed for first-time offense cure.
*   **Copyright Notice:**
